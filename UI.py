...
with col2:
    ...
    <div class="explanation">
        ...
        <b>Vault → Nutzer:</b> Der Nutzer erhält eine Bestätigung mit Zeitstempel. Damit ist das Passwort (Salt) "eingeloggt", bevor die Ziehung stattfindet. Hinweis: Das Passwort muss zwingend vor der nächsten Cut-Off-Zeit (Beginn der Ziehungen) im Vault versiegelt werden. Nach diesem Zeitpunkt ist keine Hinterlegung für die aktuelle Runde mehr möglich, um eine nachträgliche Beeinflussung des Ergebnisses auszuschließen.
    </div>
    """, unsafe_allow_html=True)
