...
st.title("🛡️ VTL (Verifiable Truth Layer) - Beweisbare Fairness")
...
with col2:
    ...
    <div class="explanation">
        ...
        <b>Nutzer → Vault:</b> Der Nutzer erstellt seine Passwort (Salt) ein.<br><br>
...
with v_col2:
    ...
    <div class="explanation">
        ...
        <b>Nutzer:</b> Der Nutzer kann nun sein ursprüngliches Passwort eingeben.<br><br>
